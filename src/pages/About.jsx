          ...
          <Grid xs={12} sm={12} md={8} lg={8} xl={8}>
              ...
              <Chip
                ...
                label={
                  <Typography
                    ...
                    sx={{ textAlign: "center" }}
                  >
                    توسعه دهنده فرانت اند و ری اکت
                  </Typography>
                }
                sx={{ p: 3 }}
              />
            ...
            <Grid container>
              ...
              <Grid xs={12} sm={8} md={9} lg={9}>
                <DevInfo>نام و نام خانوادگی : علی رضاپور</DevInfo>
                <DevInfo>سن : ۲۳</DevInfo>
                <DevInfo>شهر : بناب</DevInfo>
                <DevInfo>alirezapour781018@gmail.com : آدرس ایمیل</DevInfo>
                <DevInfo>شماره موبایل : ۰۹۱۴۷۳۱۰۴۱۱</DevInfo>
              </Grid>
            </Grid>
          </Grid>
